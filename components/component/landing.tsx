...
export function Landing() {
  return (
    <div className="flex min-h-[100dvh] flex-col bg-[#131515]">
      <header className="text-primary-foreground py-4 px-6 flex items-center justify-between">
      ...
      <main className="flex-1">
          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
              <div className="flex flex-col justify-center space-y-4">
                ...
                <button className="bg-white text-black py-2 px-4 rounded-md shadow-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-500">
        ...
        <section className="bg-muted py-12 md:py-24 lg:py-32 bg-[#ECEBF3]">
